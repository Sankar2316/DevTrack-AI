...
import { UserPlus, User, Mail, Lock, Github, AlertCircle, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 text-gray-900 dark:bg-dark-bg dark:text-gray-100 px-4 transition-colors duration-200">
      <div className="w-full max-w-md bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border p-8 rounded-3xl shadow-xl">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-400 mt-2">Create your free candidate account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-400 uppercase mb-2">Password * (min 6 chars)</label>
            <div className="relative">
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-400 uppercase mb-2">GitHub Username (Optional)</label>
            <div className="relative">
              <Github className="absolute left-3.5 top-3.5 text-gray-400" size={18} />
              <input
                type="text"
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-3.5 bg-gradient-to-r from-brand-blue to-brand-purple text-white font-semibold rounded-xl hover:opacity-90 transition flex items-center justify-center space-x-2 shadow-lg shadow-blue-500/10 mt-6"
          >
            {submitting ? (
